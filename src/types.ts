...
export interface Player {
  ...
  cardType: 'epic' | 'bigtime' | 'showtime' | 'potw' | 'highlight' | 'standard' | 'legendary' | 'epic_highlight' | 'epic_special' | 'showtime_effect' | 'showtime_template' | 'highlight_special' | 'highlight_special_alt';
  stars: 1 | 2 | 3 | 4 | 5;
  booster?: {
    name: string;
